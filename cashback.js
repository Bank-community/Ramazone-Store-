document.addEventListener('DOMContentLoaded', () => {
    ...
    const { getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, onAuthStateChanged, signOut, updateProfile } = await import("https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js");
    const { getDatabase, ref, get, set, push, onValue, query, orderByChild, equalTo } = await import("https://www.gstatic.com/firebasejs/11.6.1/firebase-database.js");

    const MASTER_REFERRAL_ID = "RMZC000B001";
    let auth, database, currentUserData, activeListeners = [];
