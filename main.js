...
async function initializeApp() {
    try {
        ...
        document.getElementById('main-content-area').innerHTML = '<div style="text-align: center; padding: 50px;">Could not initialize application. Please try again later.</div>';
    }
}
...
function loadAllData() {
    ...
    dbRef.on('value', async (snapshot) => {
        ...
        renderAllSections(data);
         ...
         document.getElementById('main-content-area').innerHTML = '<div style="text-align: center; padding: 50px;">Could not load page data. Please check your connection.</div>';
    });
}
...
// --- RENDER FUNCTIONS (Universal ones) ---
