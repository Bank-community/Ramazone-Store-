...
// --- YAHAN BADLAV KIYA GAYA HAI: Nayi setting jodi gayi hai ---
...
async function fetchAllDataAndConfig() {
    ...
    if (data.config) {
        ...
        // --- YAHAN BADLAV KIYA GAYA HAI: Nayi setting database se fetch ki ja rahi hai ---
...
function loadOrderFromCart() {
    ...
    document.getElementById('loading-indicator').style.display = 'none';
    renderOrderItems();
    updatePriceAndValidation(); // Purane function ko isse badal diya gaya hai
}
...
// Is function ka naam "updatePriceSummary" se badal kar "updatePriceAndValidation" kar diya gaya hai.
// Ab yeh price update karne ke sath-sath order ki sharton ko bhi check karega.
function updatePriceAndValidation() {
    ...
    // --- NAYA VALIDATION LOGIC SHURU ---
    const deliveryOption = document.querySelector('input[name="delivery"]:checked').value;
    const placeOrderBtn = document.getElementById('place-order-btn');
    const deliveryNotice = document.getElementById('delivery-minimum-notice');

    let isOrderable = true;
    deliveryNotice.classList.add('hidden'); // Pehle se dikh rahe message ko reset karo

    // Yadi 'Ramazone Delivery' chuna gaya hai aur minimum order value set hai
    ...
    placeOrderBtn.disabled = !isOrderable; // Button ko disable/enable karo
    if (!isOrderable) {
